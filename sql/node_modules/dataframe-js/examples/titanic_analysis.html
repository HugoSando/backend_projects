<html>
    <head>
        <script src="../dist/dataframe-min.js"></script>
    </head>
    <body>
        <script>
            ...
            DataFrame.fromCSV(
                ...
                .then(df => {
                    ...
                    console.log(
                        "Survivors:",
                        cleanDF.filter({ survived: "yes" }).count()
                    ); // We have 499 survivors.
                    console.log(
                        "Died:",
                        cleanDF
                            .filter(row => row.get("survived") === "no")
                            .count()
                    ...
                    transposedAgeEffectWithColumnNames.toCSV(
                        true,
                        "yourReport.csv"
                    );
                })
